...
import org.apache.hadoop.examples.WordCountSiCombiner.IntSumReducer;
import org.apache.hadoop.examples.WordCountSiCombiner.TokenizerMapper;
...
public class WordCountSiCombiner {
       ...
       extends Mapper<Object, Text, Text, IntWritable>{
	    ...
	    public void map(Object key, Text value, Context context
	      ...
	      while (itr.hasMoreTokens()) {	
		      ...
		      if(isValidWord((char)word.charAt(0))){
  ...
  public static void main(String[] args) throws Exception {  
    ...
    for (int i = 0; i < otherArgs.length - 1; ++i) {
      ...
      System.out.println("Time taken(mins) at WordCount : "+(endTime-startTime)/(1000));
